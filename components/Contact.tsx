    ...
    <section className="w-full max-w-7xl mx-auto px-4 pb-24 relative z-10" id="contact-section">
      ...
      <div className="flex flex-col gap-6 pl-4 font-mono text-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-8 text-base">
          ...
          >
            <span className={isDark ? 'text-primary' : 'text-primary-dark'}>&gt;</span> LinkedIn
          </a>
          <a
          ...
          >
            <span className={isDark ? 'text-primary' : 'text-primary-dark'}>&gt;</span> GitHub
          </a>
          <a
          ...
          >
            <span className={isDark ? 'text-primary' : 'text-primary-dark'}>&gt;</span> X
          </a>
        </div>
      </div>
    </section>
