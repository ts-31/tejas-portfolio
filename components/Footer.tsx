  ...
  return (
    <footer className={`w-full border-t border-primary/20 relative z-20 ${isDark ? 'bg-zinc-950' : 'bg-gray-300'}`}>
      <div className="w-full max-w-7xl mx-auto px-4">
        <div className={`w-full max-w-4xl mx-auto py-3 flex flex-col md:flex-row items-center justify-between text-xs font-mono gap-4 md:gap-0 ${isDark ? 'text-primary/60' : 'text-text-main-light'}`}>
